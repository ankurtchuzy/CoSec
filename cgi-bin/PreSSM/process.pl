...
if ($pred_seq eq $assig_seq)
	...
	$out = $dir."../../CoSec/results/pressm/".$out_file;
...
$res = $dir."../../CoSec/results/pressm/".$out_file;
...
B2
	    print "<a href = '../../CoSec/results/pressm/$out_file' download = '$task_name.txt' ><button class=\"button\" >DOWNLOAD</button></a>";
...
$stat = $dir."../../CoSec/database/job_logs_pressm.csv";
